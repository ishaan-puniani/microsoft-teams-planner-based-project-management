...
export default class ModuleService {
  ...
  async update(id, data) {
    ...
    try {
      const record = await ModuleRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async findById(id) {
    return ModuleRepository.findById(id, this.options);
  }

  async findAllAutocomplete(search, limit) {
    return ModuleRepository.findAllAutocomplete(
      search,
      limit,
      this.options,
    );
  ...
  async findAndCountAll(args) {
    return ModuleRepository.findAndCountAll(
      args,
      this.options,
    );
  }
