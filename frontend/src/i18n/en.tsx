  ...
  entities: {
    ...
    project: {
      ...
      fields: {
        ...
        userStoryTemplate: 'User Story Template',
      ...
      hints: {
        ...
        taskTemplate: 'Select the template to use for creating tasks in this project',
        bugTemplate: 'Select the template to use for creating bugs in this project',
        subtaskTemplate: 'Select the template to use for creating subtasks in this project',
        testPlanTemplate: 'Select the template to use for creating test plans in this project',
    ...
    taskTemplate: {
      ...
      placeholders: {},
      hints: {
        customFields: 'Define custom fields that will be available for this template type.',
        workflowStates: 'Define the states that items of this template can be in.',
        workflowTransitions: 'Define the transitions between states.',
      },
      new: {
    ...
    testCycle: {
      ...
      keyAutoGenerated: 'Auto-generated when project is set',
      fields: {
        id: 'Id',
        project: 'Project',
        key: 'Key',
    ...
    scheduledEvent: {
      ...
      exporterFileName: 'scheduled_events_export',
      list: {
        menu: 'Scheduled Events',
      ...
      destroyAll: {
        success: 'Scheduled Event(s) successfully deleted',
      },
      edit: {
      ...
      fields: {
        ...
        rruleFreq: 'Frequency',
        rruleFreqNone: 'No recurrence',
        rruleInterval: 'Interval',
        rruleEnd: 'End condition',
        rruleEndNone: 'Never',
        rruleEndCount: 'After N occurrences',
        rruleEndUntil: 'Until date/time',
        rruleCount: 'Occurrences',
        rruleUntil: 'Until',
        rruleByDay: 'On days',
        rruleByHour: 'By hour',
        rruleByHourHint: 'Hours to apply recurrence to (0–23), comma-separated',
        rruleByMinute: 'By minute',
        rruleByMinuteHint: 'Minutes to apply recurrence to (0–59), comma-separated',
        rruleBySecond: 'By second',
        rruleBySecondHint: 'Seconds to apply recurrence to (0–59), comma-separated',
      ...
      importer: {
        title: 'Import Scheduled Events',
        fileName: 'scheduled_event_import_template',
        hint: 'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
    tag: {
