...
const TaskTemplateListTable = (props) => {
            ...
            {!loading &&
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    {row.type ? i18n(`entities.taskTemplate.enumerators.type.${row.type}`) : ''}
                  </td>
                  <td>
...
export default TaskTemplateListTable;
