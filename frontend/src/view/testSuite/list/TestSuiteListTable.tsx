...
const TestSuiteListTable = (props) => {
  ...
  const hasPermissionToEdit = useSelector(
    testSuiteSelectors.selectPermissionToEdit,
  );
          ...
          <thead className="thead">
            <tr>
              ...
              <TableColumnHeader
                ...
                name={'name'}
                label={i18n(
                  'entities.testSuite.fields.name',
                )}
              />
...
export default TestSuiteListTable;
