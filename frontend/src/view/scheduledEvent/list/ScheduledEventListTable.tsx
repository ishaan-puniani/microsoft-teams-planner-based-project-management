...
const ScheduledEventListTable = (props) => {
              ...
              <TableColumnHeader className="th-checkbox">
                {hasRows && (
                  <div className="custom-control custom-checkbox">
                    ...
                    />
                    <label htmlFor="table-header-checkbox" className="custom-control-label">
                      &#160;
                    </label>
                  </div>
                )}
              ...
              rows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="td-actions">
                    <Link className="btn btn-link" to={`/scheduled-event/${row.id}`}>
                      {i18n('common.view')}
                    </Link>
                    {hasPermissionToEdit && (
                      <Link
                        className="btn btn-link"
                        to={`/scheduled-event/${row.id}/edit`}
                      >
                        {i18n('common.edit')}
                      </Link>
                    )}
...
export default ScheduledEventListTable;
