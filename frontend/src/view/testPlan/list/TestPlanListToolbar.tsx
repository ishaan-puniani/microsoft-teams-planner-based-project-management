...
const TestPlanToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    testPlanSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    testPlanSelectors.selectPermissionToImport,
  );
    ...
    if (disabled) {
      return (
        <span
          ...
          data-for="testPlan-list-toolbar-export-tooltip"
        >
          {button}
          <Tooltip id="testPlan-list-toolbar-export-tooltip" />
        </span>
      );
    }
    ...
    if (disabled) {
      return (
        <span
          ...
          data-tip-disable={!disabled}
          data-for="testPlan-list-toolbar-destroy-tooltip"
        >
          {button}
          <Tooltip id="testPlan-list-toolbar-destroy-tooltip" />
        </span>
      );
    }
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=testPlan">
...
export default TestPlanToolbar;
