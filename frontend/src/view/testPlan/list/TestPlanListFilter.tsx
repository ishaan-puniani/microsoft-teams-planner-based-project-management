...
const schema = yup.object().shape({
  title: yupFilterSchemas.string(
    i18n('entities.testPlan.fields.title'),
  ),
  scope: yupFilterSchemas.string(
    i18n('entities.testPlan.fields.scope'),
  ),
  objective: yupFilterSchemas.string(
    i18n('entities.testPlan.fields.objective'),
  ),
});
...
const TestPlanListFilter = (props) => {
...
export default TestPlanListFilter;
